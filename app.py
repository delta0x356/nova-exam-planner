...
def page_study_mode(user: dict):
    ...
    st.caption(
        "Pick a course or today's planned session, run a focus block, then "
        "log the completed study time directly into your plan.")
    ...
    with st.expander("About these methods"):
        st.markdown("""
**Pomodoro** uses short focus blocks, usually 25 minutes, with quick breaks.
It is useful for repetitive practice, reading, and starting when motivation is low.

**Ultradian** uses longer 90-minute focus blocks with longer recovery breaks.
It is better for deep work, mock exams, and complex problem solving.

**Custom** lets you set your own focus and break lengths for courses that need
a different rhythm.""")
